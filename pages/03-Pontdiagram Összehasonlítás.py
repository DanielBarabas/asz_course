...
with colA:
    scope_A = cs if sel_label_A == "Összes ágazat" else cs[cs["nace2_name_code"] == sel_label_A]
...
with colB:
    scope_B = cs if sel_label_B == "Összes ágazat" else cs[cs["nace2_name_code"] == sel_label_B]
